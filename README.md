...
![Nav menu](../CI_PP1_GS/docs/nav-bar.png)
...
![Main Image](../CI_PP1_GS/docs/main-image.png)
...
![Welcome](../CI_PP1_GS/docs/welcome.png)
 
- __The Map__
 
I placed a Map showing the address to the user.
 
![Map](../CI_PP1_GS/docs/map.png)
...
![Footer](../CI_PP1_GS/docs/footer.png)
